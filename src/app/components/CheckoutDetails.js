    ...
    <div>
      {successMsg ? (
        <div className="flex flex-col justify-center items-center h-[100vh] lg:h-[500px] px-6">
          ...
          <Image alt="" src={"/success-1.gif"} width={150} height={150} />
          <div className="">
            this window close in <span>{count}</span> seconds
          </div>
        </div>
      ) : (
        <div className="lg:gap-x-8 h-full lg:px-12 lg:py-8">
          <h2
            className="mb-6 text-[20px] uppercase font-extrabold 
        text-center lg:text-left pt-6 lg:pt-0 "
          >
            Shopping & Checkout
          </h2>
          <div
            className="h-[86vh] lg:h-[47vh] flex flex-col 
        lg:flex-row lg:gap-x-4"
          >
            <div
              className="flex-1 h-full
           overflow-y-auto 
          lg:overflow-visible   scrollbar-thin scrollbar-thumb-orange 
            scrollbar-track-white-500 py-4 px-8 lg:py-0 lg:px-0"
            >
              <div
            ...
            <div
              className="flex-1 h-full 
          lg:max-w-[40%] flex flex-col  justify-between pt-3 px-8 lg:p-0
         "
            >
              <div className="border rounded-lg flex flex-col mb-4 p-4 h-full">
                <h3
                  className="text-base font-extrabold
             uppercase mb-4 border-b pb-4"
                >
                  Your order
                </h3>
                <div
            ...
            scrollbar-track-white-500 font-semibold
