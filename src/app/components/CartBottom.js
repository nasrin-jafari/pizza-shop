...
const CartBottom = () => {
  ...
  return (
    <>
      {cart.length >= 1 ? (
        <div className="px-6 py-3 lg:py-6 mt-auto border-t border-black/2">
          <div
      ...
      {modal && (
        ...
        lg:max-h-[550px] lg:rounded-[30px] lg:fixed lg:top-[50%]
        ...
        >
          <div
           ...
           top-2 hover:scale-110 duration-200 cursor-pointer"
          >
